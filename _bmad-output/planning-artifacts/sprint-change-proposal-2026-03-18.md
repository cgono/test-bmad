...
```
AWS credential verification: `arn:aws:iam::135263544996:user/ReadingAssistantDevUser` — credentials **valid**, Textract permission **confirmed** (`UnsupportedDocumentException` returned on dummy payload, not `AccessDeniedException`).
